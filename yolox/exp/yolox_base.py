...
class Exp(BaseExp):
    ...
    def get_model(self):
        ...
        if getattr(self, "model", None) is None:
            ...
            if self.head_type == "ORI":
                head = OritateHead(self.num_classes, self.width, in_channels=in_channels, act=self.act)
            else:
                head = YOLOXHead(self.num_classes, self.width, in_channels=in_channels, act=self.act)
            self.model = YOLOX(backbone, head ,self.head_type)
