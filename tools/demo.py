...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="/home/rvl224/文件/MVTEC/images/screws_044.png", help="path to images or video"
    )
    ...
    parser.add_argument("-c", "--ckpt", default="backup/0427.pth", type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="cpu",
        type=str,
